...
SET TO_LAUNCH=fr.flegac.civ.server.CivServerRunner
SET ARG0=%CIV_PATH%conf

"%JAVA_HOME%\bin\java.exe" -Dfile.encoding=UTF-8 %JVM_PARAM% -classpath %classpath% -Djava.library.path=%LWJGL_NATIVE_LIBRARY_PATH% %TO_LAUNCH% %ARG0% 4444
